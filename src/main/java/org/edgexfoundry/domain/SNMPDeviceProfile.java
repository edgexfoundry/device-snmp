...
public class SNMPDeviceProfile extends DeviceProfile {
	
	private List<SNMPObject> SNMPResources = new ArrayList<SNMPObject>();

	public SNMPDeviceProfile(DeviceProfile profile) {
	...
	public List<SNMPObject> getSNMPResources() {
		return SNMPResources;
	}

	public void setSNMPResources(List<SNMPObject> objects) {
		this.SNMPResources = objects;
	}
