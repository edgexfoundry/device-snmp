...
import org.edgexfoundry.domain.SNMPDeviceProfile;
...
public class SNMPDevice extends Device {
	...
	private SNMPDeviceProfile profile;
	...
	public SNMPDevice(Device device) {
		...
		this.setSNMPProfile(new SNMPDeviceProfile(device.getProfile()));
	...
	public SNMPDeviceProfile getSNMPProfile() {
		if (profile == null) {
			this.profile = new SNMPDeviceProfile(getProfile());
		}
		return profile;
	}

	public void setSNMPProfile(SNMPDeviceProfile profile) {
